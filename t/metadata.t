...
is-deeply %prop<border>, {:box, :children["border-width", "border-style"], :edges["border-top", "border-right", "border-bottom", "border-left"], :!inherit, :synopsis("line-width> || <line-style> || <color>")}, 'border';
